...
func (b *PreemptionConfigNumericLabelConstraintApplyConfiguration) WithComparison(value kueuev1beta2.NumericComparison) *PreemptionConfigNumericLabelConstraintApplyConfiguration {
	b.Comparison = &value
	return b
}
