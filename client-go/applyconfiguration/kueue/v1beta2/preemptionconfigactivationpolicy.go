...
type PreemptionConfigActivationPolicyApplyConfiguration struct {
	...
	Trigger *kueuev1beta2.PreemptionConfigActivationTrigger `json:"trigger,omitempty"`
}
...
func (b *PreemptionConfigActivationPolicyApplyConfiguration) WithTrigger(value kueuev1beta2.PreemptionConfigActivationTrigger) *PreemptionConfigActivationPolicyApplyConfiguration {
	b.Trigger = &value
	return b
}
